...
class MysqliThread extends SqlSlaveThread{
	...
	public function __construct(MysqlCredentials $credentials, SleeperHandlerEntry $entry, AttachableThreadSafeLogger $logger, QuerySendQueue $bufferSend, QueryRecvQueue $bufferRecv){
